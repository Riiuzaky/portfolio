  ...
  return (
    <>
      ...
      <div>
        ...
        >
          Conozco en tecnologías como PlayWright, Selenium, Appium, Jmeter, React, Node.js y Express, disfruto
          aprendiendo rápidamente y aplicando mis habilidades en el desarrollo
          de aplicaciones y el aseguramiento de la calidad de web intuitivas y eficientes. Apasionado por la calidad
          y la innovación, estoy listo para colaborar en proyectos desafiantes y
          llevar ideas a la realidad.
        </motion.p>
        <div className="grid grid-cols-1 mt-8">
          <a
            href="./../assets/Curriculum-Jonathan-Cruz.pdf"
            download
          ...
          <a
            href=""
            download
            className="hidden bg-tertiary rounded-[20px] py-2 px-4 mt-6 min-h-[50px] w-64 flex justify-evenly items-center flex-col"
          >
            Descargar CV - Ingles
          </a>
        </div>
